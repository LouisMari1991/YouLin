...
import youlin.xinhua.com.youlin.adapter.BaseRecyclerAdapter;
import youlin.xinhua.com.youlin.adapter.SmartViewHolder;
...
public class WaterDropStyleActivity extends AppCompatActivity implements AdapterView.OnItemClickListener {
    ...
    public static void start(Context context) {
        Intent starter = new Intent(context, WaterDropStyleActivity.class);
