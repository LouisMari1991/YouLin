  ...
  private synchronized void autoFocusAgainLater() {
    if (!stopped && outstandingTask == null) {
      ...
      try {
        ...
        LogUtils.e(TAG, "Could not request auto focus", ree);
      }
    }
  }
    ...
    if (useAutoFocus) {
      ...
      if (!stopped && !focusing) {
        try {
          ...
          LogUtils.e(TAG, "Unexpected exception while focusing", re);
  ...
  public synchronized void stop() {
    ...
    if (useAutoFocus) {
      ...
      try {
        ...
        // Have heard RuntimeException reported in Android 4.0.x+; continue?
        LogUtils.e(TAG, "Unexpected exception while cancelling focusing", re);
      }
    }
  }
