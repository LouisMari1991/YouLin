...
public class LogUtils {
  ...
  @IntDef({ V, D, I, W, E, A }) @Retention(RetentionPolicy.SOURCE) public @interface TYPE {
  }
  ...
  public static class Builder {
    ...
    public Builder() {
      if (Environment.MEDIA_MOUNTED.equals(Environment.getExternalStorageState())) {
        dir = MApp.get().getExternalCacheDir() + File.separator + "log" + File.separator;
      } else {
        dir = MApp.get().getCacheDir() + File.separator + "log" + File.separator;
      }
    }
  ...
  private static String[] processContents(int type, String tag, Object... contents) {
    ...
    String head = new Formatter().format("Thread: %s, %s(%s.java:%d)" + LINE_SEPARATOR,
        Thread.currentThread().getName(), targetElement.getMethodName(), className,
