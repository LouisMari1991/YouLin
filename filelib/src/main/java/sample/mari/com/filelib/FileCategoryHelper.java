...
public class FileCategoryHelper {
  ...
  final public static int NAME = 0x018;
  final public static int SIZE = 0x019;
  final public static int DATE = 0x020;
  final public static int TYPE = 0x021;
  ...
  @Retention(RetentionPolicy.SOURCE) @Target(PARAMETER) @IntDef({ NAME, SIZE, DATE, TYPE })
  ...
  private String buildSelectionByCategory(@FileCategory int category) {
    ...
    switch (category) {
      ...
      case Zip:
        selection =
            "(" + MediaStore.Files.FileColumns.MIME_TYPE + " == '" + sZipFileMimeType + "')";
        break;
      case Apk:
  ...
  private String buildSortOrder(@SortMethod int sort) {
    ...
    switch (sort) {
      ...
      case DATE:
        ...
        break;
      case TYPE:
        sortOrder = MediaStore.Files.FileColumns.MIME_TYPE
            + " asc, "
  ...
  private String buildDocSelection() {
    ...
    while (iter.hasNext()) {
      selection.append(
          "(" + MediaStore.Files.FileColumns.MIME_TYPE + "=='" + iter.next() + "') OR ");
    }
